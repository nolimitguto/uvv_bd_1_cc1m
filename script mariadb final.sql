...
ALTER TABLE regioes COMMENT 'tabela sobre as regioes';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'chave primaria da tabela regioes sobre a identificaçao das reioes';

ALTER TABLE regioes MODIFY COLUMN nome_regiao VARCHAR(25) COMMENT 'chave alternativa sobre o nome das regioes da tabela regioes';
...
ALTER TABLE paises COMMENT 'tabela sobre os paises';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'coluna sobre as identificaçoes dos paises';

ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'chave estrangeira sobre a identificaçao das regioes';

ALTER TABLE paises MODIFY COLUMN nome_pais VARCHAR(50) COMMENT 'chave alternativa da tabela paises sobre o nome dos paises';
...
ALTER TABLE localizacoes COMMENT 'tabela sobre as localizaçoes';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'chave primaria da tabela localizaçoes sobre a identificaçao das localizaçoes';

ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR(2) COMMENT 'chave estrangeira sobre a indentificaçao do pais da localizaçao vindo da tabela paises';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(45) COMMENT 'coluna endereço da tabela localizaçoes onde define o endereço de cada localizaçao';

ALTER TABLE localizacoes MODIFY COLUMN CEP VARCHAR(12) COMMENT 'coluna sobre cep da tabela localizaçoes onde define o cep de cada localizaçao';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'coluna sobre as unidades federais localizadas cada localizaçao';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(40) COMMENT 'coluna sobre as cidades da tabela localizaçoes';
...
ALTER TABLE cargos COMMENT 'tabela sobre os cargos';

ALTER TABLE cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'chave primaria sobre a tabela cargos fazendo a funçao da identificaçao dos cargos';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'chave alternativa da tabela cargos identificando o nome de cada cargo';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'definiçao de cada salario minimo de cada cargo';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'definiçao do salario maximo de cada cargo';
...
ALTER TABLE empregados COMMENT 'tabela sobre os empregados';

ALTER TABLE empregados MODIFY COLUMN id_empregado INTEGER COMMENT 'chave primaria sobre a tabela empregados onde identifica os empregados';

ALTER TABLE empregados MODIFY COLUMN nome VARCHAR(75) COMMENT 'coluna sobre os nomes de cada empregado';

ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'coluna sobre os emails dos empregados';

ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'coluna sobre os telefones dos funcionarios';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'coluna sobre as datas de conrrataçao de cada funcionario';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'chave estrangeira da tabela cargos sobre a identificaçao dos cargos';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'coluna sobre os salarios de cada funcionario';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'coluna sobre a comissao de cada funcionario';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'chave estrangeira sobre a identificaçao de cada departamento de cada funcionario vindo da tabela departamentos';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'referencia sobre a propria tabela empregados identificando o supervisor de cada funcionario';
...
ALTER TABLE departamentos COMMENT 'tabela sobre os departamentos';

ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'chave primaria sobre a identificaçao dos departamentos';

ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'chave estrangeira vindo da tabela localizaçoes fazendo referencia a identificaçao das localizaçoes de cada departamento';

ALTER TABLE departamentos MODIFY COLUMN nome_departamento VARCHAR(20) COMMENT 'coluna sobre o nome de cada departamento';

ALTER TABLE departamentos MODIFY COLUMN id_gerente INTEGER COMMENT 'chave estrangeira sobre a identificaçao de cada gerente de cada departamento';
...
ALTER TABLE historico_cargos COMMENT 'tabela sobre os historicos dos cargos';

ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'chave primaria da tabela historico_cargos sobre a data_inicial de cada funcionario';

ALTER TABLE historico_cargos MODIFY COLUMN id_empregado INTEGER COMMENT 'chave estrangeira sobre a identificaçao dos empregados da tabela empregados';

ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'chave estrangeira sobre a indentificaçao dos cargos sobre a tabela cargos';

ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'data final sobre a demissao dos empregados';

ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'chave estrangeira sobre a tabela departamentos sobre a identificaçao dos departamentos na tabela historico_cargos';
...
/*aconteceu um erro no id_gerente com a tabela empregados a resoluçao para esse problema esta no final do codigo*/
INSERT INTO departamentos (id_departamento, nome_departamento, id_localizacao) VALUES
...
INSERT INTO historico_cargos (id_empregado, data_inicial, data_final,
id_cargo, id_departamento) VALUES
(114, '2006-03-25', '2007-12-31', 'ST_CLERK', '50');
INSERT INTO historico_cargos (id_empregado, data_inicial, data_final,
id_cargo, id_departamento) VALUES
(122, '2007-01-02', '2007-12-31', 'ST_CLERK', '50');
INSERT INTO historico_cargos (id_empregado, data_inicial, data_final,
id_cargo, id_departamento) VALUES
...
(200, '2002-07-01', '2006-12-31', 'AC_ACCOUNT', '90');
 /*aconteceu um problema enquanto inseria os codigos a unica maneira que encontrei foi adicionar os id_gerente no final do codigo apos remove-los da parte principal*/
