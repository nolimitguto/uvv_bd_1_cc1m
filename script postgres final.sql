...
CREATE DATABASE uvv
    ...
    /*criando as tabelas e as constraints*/
...
COMMENT ON TABLE hr.regioes IS 'tabela sobre as regioes';
COMMENT ON COLUMN hr.regioes.id_regiao IS 'chave primaria da tabela regioes sobre a identificaçao das reioes';
COMMENT ON COLUMN hr.regioes.nome_regiao IS 'chave alternativa sobre o nome das regioes da tabela regioes';
...
COMMENT ON TABLE hr.paises IS 'tabela sobre os paises';
COMMENT ON COLUMN hr.paises.id_pais IS 'coluna sobre as identificaçoes dos paises';
COMMENT ON COLUMN hr.paises.id_regiao IS 'chave estrangeira sobre a identificaçao das regioes';
COMMENT ON COLUMN hr.paises.nome_pais IS 'chave alternativa da tabela paises sobre o nome dos paises';
...
COMMENT ON TABLE hr.localizacoes IS 'tabela sobre as localizaçoes';
COMMENT ON COLUMN hr.localizacoes.id_localizacao IS 'chave primaria da tabela localizaçoes sobre a identificaçao das localizaçoes';
COMMENT ON COLUMN hr.localizacoes.id_pais IS 'chave estrangeira sobre a indentificaçao do pais da localizaçao vindo da tabela paises';
COMMENT ON COLUMN hr.localizacoes.endereco IS 'coluna endereço da tabela localizaçoes onde define o endereço de cada localizaçao';
COMMENT ON COLUMN hr.localizacoes.CEP IS 'coluna sobre cep da tabela localizaçoes onde define o cep de cada localizaçao';
COMMENT ON COLUMN hr.localizacoes.uf IS 'coluna sobre as unidades federais localizadas cada localizaçao';
COMMENT ON COLUMN hr.localizacoes.cidade IS 'coluna sobre as cidades da tabela localizaçoes';
...
COMMENT ON TABLE hr.cargos IS 'tabela sobre os cargos';
COMMENT ON COLUMN hr.cargos.id_cargo IS 'chave primaria sobre a tabela cargos fazendo a funçao da identificaçao dos cargos';
COMMENT ON COLUMN hr.cargos.cargo IS 'chave alternativa da tabela cargos identificando o nome de cada cargo';
COMMENT ON COLUMN hr.cargos.salario_minimo IS 'definiçao de cada salario minimo de cada cargo';
COMMENT ON COLUMN hr.cargos.salario_maximo IS 'definiçao do salario maximo de cada cargo';
...
COMMENT ON TABLE hr.empregados IS 'tabela sobre os empregados';
COMMENT ON COLUMN hr.empregados.id_empregado IS 'chave primaria sobre a tabela empregados onde identifica os empregados';
COMMENT ON COLUMN hr.empregados.nome IS 'coluna sobre os nomes de cada empregado';
COMMENT ON COLUMN hr.empregados.email IS 'coluna sobre os emails dos empregados';
COMMENT ON COLUMN hr.empregados.telefone IS 'coluna sobre os telefones dos funcionarios';
COMMENT ON COLUMN hr.empregados.data_contratacao IS 'coluna sobre as datas de conrrataçao de cada funcionario';
COMMENT ON COLUMN hr.empregados.id_cargo IS 'chave estrangeira da tabela cargos sobre a identificaçao dos cargos';
COMMENT ON COLUMN hr.empregados.salario IS 'coluna sobre os salarios de cada funcionario';
COMMENT ON COLUMN hr.empregados.comissao IS 'coluna sobre a comissao de cada funcionario';
COMMENT ON COLUMN hr.empregados.id_departamento IS 'chave estrangeira sobre a identificaçao de cada departamento de cada funcionario vindo da tabela departamentos';
COMMENT ON COLUMN hr.empregados.id_supervisor IS 'referencia sobre a propria tabela empregados identificando o supervisor de cada funcionario';
...
COMMENT ON TABLE hr.departamentos IS 'tabela sobre os departamentos';
COMMENT ON COLUMN hr.departamentos.id_departamento IS 'chave primaria sobre a identificaçao dos departamentos';
COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'chave estrangeira vindo da tabela localizaçoes fazendo referencia a identificaçao das localizaçoes de cada departamento';
COMMENT ON COLUMN hr.departamentos.nome_departamento IS 'coluna sobre o nome de cada departamento';
COMMENT ON COLUMN hr.departamentos.id_gerente IS 'chave estrangeira sobre a identificaçao de cada gerente de cada departamento';
...
CREATE TABLE hr.historico_cargos (
                ...
                data_final DATE,
                id_departamento INTEGER,
                CONSTRAINT data_inicial PRIMARY KEY (data_inicial)
);
COMMENT ON TABLE hr.historico_cargos IS 'tabela sobre os historicos dos cargos';
COMMENT ON COLUMN hr.historico_cargos.data_inicial IS 'chave primaria da tabela historico_cargos sobre a data_inicial de cada funcionario';
COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'chave estrangeira sobre a identificaçao dos empregados da tabela empregados';
COMMENT ON COLUMN hr.historico_cargos.id_cargo IS 'chave estrangeira sobre a indentificaçao dos cargos sobre a tabela cargos';
COMMENT ON COLUMN hr.historico_cargos.data_final IS 'data final sobre a demissao dos empregados';
COMMENT ON COLUMN hr.historico_cargos.id_departamento IS 'chave estrangeira sobre a tabela departamentos sobre a identificaçao dos departamentos na tabela historico_cargos';
...
INSERT INTO hr.regioes (id_regiao, nome_regiao) VALUES
(1, 'Europe');
INSERT INTO hr.regioes (id_regiao, nome_regiao) VALUES
(2, 'Americas');
INSERT INTO hr.regioes (id_regiao, nome_regiao) VALUES
...
INSERT INTO hr.paises (id_pais, nome_pais, id_regiao) VALUES
('AR' , 'Argentina', 2 );
INSERT INTO hr.paises (id_pais, nome_pais, id_regiao) VALUES
('AU' , 'Australia', 3 );
INSERT INTO hr.paises (id_pais, nome_pais, id_regiao) VALUES
...
/*aconteceu um erro no id_gerente com a tabela hr.empregados a resoluçao para esse problema esta no final do codigo*/
INSERT INTO hr.departamentos (id_departamento, nome_departamento, id_localizacao) VALUES
...
INSERT INTO hr.historico_cargos (id_empregado, data_inicial, data_final,
